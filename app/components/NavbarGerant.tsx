  ...
  return (
    <>
      ...
      <nav className="navbar">
        <Link href="/gerant/tableau-de-bord" className="navbar-brand">Top Service</Link>
        ...
        <div style={{ position: 'relative' }}>
          ...
          >
            <div style={{
              ...
              background: 'linear-gradient(135deg, var(--or), var(--orange-dark))',
              ...
              <div style={{ padding: '8px' }}>
                {LIENS.map(({ href, label }) => (
                  <Link key={href} href={href} onClick={() => setOuvert(false)} style={{
                    ...
                    background: pathname.startsWith(href) ? 'rgba(249,115,22,0.07)' : 'transparent',
